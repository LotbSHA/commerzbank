...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "commerzbank@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "commerzbank API";

        private String description = "commerzbank API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "commerzbank";
