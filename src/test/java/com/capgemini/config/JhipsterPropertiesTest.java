...
public class JhipsterPropertiesTest {
	...
	public void setFrom() {
		Mail mail =new Mail();
		mail.setFrom("commerzbank@localhost");
		assertTrue(mail.getFrom()=="commerzbank@localhost");
	}
	...
	public void setPrefix(){
		...
		graphite.setPrefix("commerzbank");
		assertTrue(graphite.getPrefix()=="commerzbank");
	}
